...
import psdi.plust.app.workorder.PlusTWPMaterialSet;
 ...
 * @author TOSHIBA
 */
public class ITCWPMaterialSet extends PlusTWPMaterialSet implements ITCWPMaterialSetRemote {
    ...
    public ITCWPMaterialSet(MboServerInterface ms) throws MXException, RemoteException {
        super(ms);
    }

    @Override
    protected Mbo getMboInstance(MboSet mboset) throws MXException, RemoteException {
        return new ITCWPMaterial(mboset);
    }
    ...
    public void itcCalculaPrecioOT() throws MXException, RemoteException {
        ...
        for (ITCWPMaterialRemote wpmaterialMbo = (ITCWPMaterialRemote) this.moveFirst(); wpmaterialMbo != null; wpmaterialMbo = (ITCWPMaterialRemote) this.moveNext()) {
