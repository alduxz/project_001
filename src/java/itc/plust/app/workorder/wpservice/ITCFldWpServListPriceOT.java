 ...
 * @author TOSHIBA
 */
public class ITCFldWpServListPriceOT extends MboValueAdapter {
    ...
    public ITCFldWpServListPriceOT(MboValue mbv) throws MXException {
        super(mbv);
    }
    ...
    public void action() throws MXException, RemoteException {
        ...
        if (thisMbo != null) {
            ...
            ITCWPServiceRemote wpservicioMbo = (ITCWPServiceRemote) thisMbo;

            logdebug(LOGRUNNING, "ITCWPServiceRemote.itcCalcularMargen(getMboValue())");
            wpservicioMbo.itcCalcularMargen();
        }
