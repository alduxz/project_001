...
/**
 *
 * @author ekishimoto obtener el precio de lista segun la moneda del proveedor
 */
public class ITCFldWpServPrecioListaProv extends MboValueAdapter {
    ...
    public ITCFldWpServPrecioListaProv(MboValue mbv) {
        super(mbv);
    }
