 ...
 * @author ITCONSOL-06
 */
public class ITCFldWpLaborValorVenta extends MboValueAdapter {
    ...
    public ITCFldWpLaborValorVenta(MboValue mbv) throws MXException, RemoteException {
        super(mbv);
    }
    ...
    public void action() throws MXException, RemoteException {
        ...
        logdebug(LOGRUNNING, "thisWO.itcIncrTotalManoObra(newValue);");
        thisWO.itcIncrTotalManoObra(newValue);
