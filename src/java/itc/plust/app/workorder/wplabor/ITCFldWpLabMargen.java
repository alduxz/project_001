...
/**
 *
 * @author TOSHIBA Clase para actualizar los importes segun el margen de
 * ganancia
 */
public class ITCFldWpLabMargen extends MboValueAdapter {
    ...
    public ITCFldWpLabMargen(MboValue mbv) throws MXException {
        super(mbv);
    }
    ...
    public void action() throws MXException, RemoteException {
        ...
        if (thisMbo != null) {
            ITCWPLaborRemote wplaborMbo = (ITCWPLaborRemote) thisMbo;

            logdebug(LOGRUNNING, "ITCWPLaborRemote.itcCalcularMargen(getMboValue())");
            wplaborMbo.itcCalcularMargen();
        }
